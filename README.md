...
Hi, I am Peperehobbits01! A small developer that likes to learn things, and takes time to make stuff correctly. Mostly working on my own project for now. I might help open source project other then my own soon! I like privacy and think that it should be a standard. I am using Linux (not arch by the way) and I am working on what we could say are some big projects, like my Minecraft Modpack, The Milkyway SMP! 
